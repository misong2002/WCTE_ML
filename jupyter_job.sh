...
PROJECT_DIR=/project/def-blairt2k/machine_learning

echo "Entering singularity container"
${PROJECT_DIR}/enter_container.sh ${PROJECT_DIR}/start_jupyternotebook.sh
